...
router.post("/detect-type", auth_1.isAuthenticated, contract_controller_1.uploadMiddleware, (0, errors_1.handleErrors)(contract_controller_1.detectAndConfirmContractType) // Fixed typo here
);
